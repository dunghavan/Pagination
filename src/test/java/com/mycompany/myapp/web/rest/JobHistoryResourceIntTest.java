...
import com.mycompany.myapp.TestPaginationApp;
...
@SpringBootTest(classes = TestPaginationApp.class)
public class JobHistoryResourceIntTest {
    ...
    public void setup() {
        ...
        final JobHistoryResource jobHistoryResource = new JobHistoryResource(jobHistoryRepository);
